    ...
    <div class="container page-content">
        ...
        <div class="row">
            <div class="col-lg-9 col-md-12">
                ...
                <p><small><i class="fas fa-info-circle mr-2"></i> At the time, I personally wrote the Final Fantasy VII guides, copying them from the 1997 official guide. Due to my young age I didn't check the sources and the contents inserted by the other contributors of the site, so as a disclaimer I say that some contents could have been copied from sources, up to this day, unknown to me.</small>
                </p>
            </div> <!-- ./ item col -md-12 -->
